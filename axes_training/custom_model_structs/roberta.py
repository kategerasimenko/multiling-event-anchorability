...
class RobertaClassificationOnTokenHead(RobertaClassificationHead):
...
class RobertaForSequenceClassificationOnToken(RobertaPreTrainedModel):
    ...
    def __init__(self, config):
        ...
        self.classifier = RobertaClassificationOnTokenHead(config)
